...
<div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="/admin/menus">Pratos</a></li>
        <li class="active"><a href="/admin/menus/create">Cadastrar</a></li>
      </ol>
    </section>
      ...
      <div class="row">
          <div class="col-md-12">
            ...
            <div class="box-header with-border">
              <h3 class="box-title">Novo Prato</h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
            <form role="form" action="/admin/menus/create" method="post" enctype="multipart/form-data">
                <div class="box-body">
                    <div class="form-group">
                      <label for="desmenu">Nome do Prato</label>
                      <input type="text" class="form-control" id="desmenu" name="desmenu" placeholder="Digite o nome do prato" >
                    </div>
                    <div class="form-group">
                        <label>Loja</label>
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control" id="descompossition" name="descompossition" rows="3" placeholder="Description..."></textarea>
                    </div>
                    <div class="form-group">
