...
<head>
    ...
    <title>Cardápio - <?php echo htmlspecialchars( $store, ENT_COMPAT, 'UTF-8', FALSE ); ?></title>
...
<body>
    <nav class="navbar navbar-dark navbar-expand-lg fixed-top bg-white portfolio-navbar gradient" style="background-color: #4b3519 !important;">
        <div class="container">
            <a class="navbar-brand logo" href="#">
                <?php echo htmlspecialchars( $store, ENT_COMPAT, 'UTF-8', FALSE ); ?>
            </a>
            ...
            <div class="collapse navbar-collapse"
                ...
                <ul class="nav navbar-nav ml-auto">
                    <li class="nav-item" role="presentation"><a class="nav-link" href="/">Voltar para o início</a></li>
    ...
    <section class="portfolio-block project-no-images">
        ...
        <div class="container" style="margin-top: 100px;">
            ...
            <?php $counter1=-1;  if( isset($categories) && ( is_array($categories) || $categories instanceof Traversable ) && sizeof($categories) ) foreach( $categories as $key1 => $value1 ){ $counter1++; ?>                
                <div class="row">
                    <div class="col-12">
                        <h3 id="<?php echo htmlspecialchars( $value1["descategory"], ENT_COMPAT, 'UTF-8', FALSE ); ?>">
                            <?php echo htmlspecialchars( $value1["descategory"], ENT_COMPAT, 'UTF-8', FALSE ); ?>
                            <?php if( $value1["idcategory"] == 6 ){ ?>
                                <small class="text-muted" style="font-size: 15px !important;">&nbsp;&nbsp;Meio prato será cobrado 70% do valor</small> 
                            <?php } ?>
                        </h3>  
                            <?php if( $value1["idcategory"] == 5 ){ ?>
                                <small class="text-muted" style="margin-left: 5px;">De Segunda a Sexta ( Almoço )&nbsp; - Exceto feriados</small> 
                            <?php } ?>
                            <?php if( $value1["idcategory"] == 3 ){ ?>
                                <small class="text-muted" style="margin-left: 5px;">De Segunda a Sexta ( Almoço )&nbsp; - Exceto feriados</small> 
                            <?php } ?>
                            <?php if( $value1["idcategory"] == 2 ){ ?>
                                <small class="text-muted" style="margin-left: 5px;">De Segunda a Sexta ( Almoço )&nbsp; - Exceto feriados</small> 
                            <?php } ?>
                        <br>                     
                        <br>
                    </div>
                    <?php $idcategory = $value1["idcategory"]; ?>
                    <?php $counter2=-1;  if( isset($menus) && ( is_array($menus) || $menus instanceof Traversable ) && sizeof($menus) ) foreach( $menus as $key2 => $value2 ){ $counter2++; ?>
                    <?php if( $idcategory == $value2["idcategory"] ){ ?>
                    <div class="col-md-6 col-lg-6">
                        <div class="project-card-no-image">
                            <div class="row">
                                <div class="col-8">
                                    <h3><?php echo htmlspecialchars( $value2["desmenu"], ENT_COMPAT, 'UTF-8', FALSE ); ?></h3>
                                    <h4 style="font-size:15px !important;"><?php echo htmlspecialchars( $value2["descompossition"], ENT_COMPAT, 'UTF-8', FALSE ); ?></h4>
                                    <a  role="button" href="#">R$<?php echo formatPrice($value2["vlprice"]); ?></a>
                                    <div class="tags"></div>
                                </div>
                                <div class="col-4" style="max-height: 200px !important;">
                                    <img src="/res/site/img/<?php echo htmlspecialchars( $value2["desphoto"], ENT_COMPAT, 'UTF-8', FALSE ); ?>" style="width: 100% !important;border-radius: 5px;max-height: 200px;">
                                </div>
                                <div class="col-12">
                                    <?php if( $idcategory == 5 ){ ?>
                                      <small class="text-muted">De Segunda a Sexta ( Almoço )&nbsp; - Exceto feriados</small> 
                                    <?php } ?>
                                    <?php if( $idcategory == 3 ){ ?>
                                      <small class="text-muted">De Segunda a Sexta ( Almoço )&nbsp; - Exceto feriados</small> 
                                    <?php } ?>
