...
<head>
  ...
  <title>Cardápio Admin | Manager</title>
...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="/admin" class="logo">
      ...
      <span class="logo-lg"><b>Armazem</b>82</span>
    </a>
          ...
          <li class="dropdown user user-menu">
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-header">
                ...
                <p>
                  ...
                  <?php }else{ ?>
                    Usuário
                  <?php } ?>
                  <small><?php echo date("\D\i\a d \d\o m \- Y"); ?></small>
                </p>
              </li>
              <!-- Menu Body -->
              <li class="user-body">
              ...
              <li class="user-footer">
                <div class="pull-left">
                  <a href="/admin/users/<?php echo getUserId(); ?>" class="btn btn-default btn-flat">Profile</a>
                </div>
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        ...
        <li><a href="/admin/stores"><i class="fa fa-link"></i> <span>Lojas</span></a></li>
        <li><a href="/admin/categories"><i class="fa fa-link"></i> <span>Categorias</span></a></li>
        <li><a href="/admin/menus"><i class="fa fa-link"></i> <span>Pratos</span></a></li>
      </ul>
      <!-- /.sidebar-menu -->
    </section>
    <!-- /.sidebar -->
