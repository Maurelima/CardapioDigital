              ...
              <div class="box-tools">
                <form action="/admin/categories">
                  <div class="input-group input-group-sm" style="width: 250px;">
                    ...
                    <input type="text" name="qtdcategories" class="form-control pull-right" value="<?php echo htmlspecialchars( $qtdcategories, ENT_COMPAT, 'UTF-8', FALSE ); ?>">
                  </div>
                </form>
              </div>
            </div>
              ...
              <table class="table table-striped">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>
                      <a href="/admin/categories/<?php echo htmlspecialchars( $value1["idcategory"], ENT_COMPAT, 'UTF-8', FALSE ); ?>/menus" class="btn btn-default btn-xs"><i class="fa fa-edit"></i> Pratos</a>
